...
int main(int argc, char** argv) {
	...
	Core::readImagePGM("D:/College/2nd sem/GPU_LAB/exercise/Opencl-ex1 (1)/Opencl-ex1/Opencl-ex1/images/Teddy_L.pgm", inputDataL, inputWidthL, inputHeightL);
	Core::readImagePGM("D:/College/2nd sem/GPU_LAB/exercise/Opencl-ex1 (1)/Opencl-ex1/Opencl-ex1/images/Teddy_R.pgm", inputDataR, inputWidthR, inputHeightR);
	...
	for (int impl = 1; impl <= 2; impl++)
	{
		...
		disparityMapping.setArg<cl_int>(3, window_size);
		disparityMapping.setArg<cl_int>(4, disparityMax);
		...
		if (impl == 1)
		{
			Core::writeImagePGM("output_disparity_GPU_SAD" + boost::lexical_cast<std::string> (impl) + ".pgm", h_outputGpu, countX, countY);
		}
		if (impl == 2)
		{
			Core::writeImagePGM("output_disparity_GPU_SSD" + boost::lexical_cast<std::string> (impl) + ".pgm", h_outputGpu, countX, countY);
		}
